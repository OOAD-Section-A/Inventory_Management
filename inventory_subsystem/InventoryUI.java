...
public interface InventoryUI {
    ...
    int getReorderThreshold(String productId, String locationId);

    int getSafetyStockLevel(String productId, String locationId);

    String getAbcCategory(String productId, String locationId);
}
